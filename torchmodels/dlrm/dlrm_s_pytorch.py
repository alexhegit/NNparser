...
def model(): #default config, 0618
    ...
    #lS_i = [torch.Tensor([1,0,1]),torch.Tensor([0,1]),torch.Tensor([1,0])]
    #lS_o = torch.Tensor([[0,1],[0,1],[0,1]])
    #x = torch.rand(2,4)
    #model=dlrm(x, lS_o, lS_i)
    return dlrm
